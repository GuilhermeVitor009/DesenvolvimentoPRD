...
String messages[5][5];// mensagens inseridas nos blocos
String mapa[5][5];//mapa com as strings de identificação dos blocos
String mapaObjetivo[5][5];// mapa apenas com os (:objective-0) dos blocos
...
void movimentacao(int posicaoZ, int posicaoX){
  ...
  stepperZ.moveTo(posicaoZ);
    ...
    Serial.println( "\nPosição(Z-X): " + (String)(stepperZ.currentPosition() / 1509) + "x" + (String)(stepperX.currentPosition() / 1509) );
}
