  ...
  //Fim de Set para mensagens
      ...
      if (temBloco == "A" || temBloco == "B" || temBloco == "C" || temBloco == "D" || temBloco == "E"){
        ...
        if ((posicaoAtual - posicaoPassada) <= 4){
          ...
          j = posicaoAtual - 14;
        }else if (((posicaoAtual - posicaoPassada) == 5) && (posicaoAtual < 24)){
          posicaoPassada = posicaoAtual;
...
String identifica(){
   ...
   if (uid == "D5 49 25 D9"){
      ...
      Serial.println("\nO bloco D esta na posição: " + (String)(stepperZ.currentPosition() / 3773) + "x" + (String)(stepperX.currentPosition() / 3764)  );
      
      return "D" + tagToString();
   }else if (uid == "E2 39 55 DD"){
      Serial.println("\nO bloco E esta na posição: " + (String)(stepperZ.currentPosition() / 3773) + "x" + (String)(stepperX.currentPosition() / 3764)  );
